...
list_2 = []
for num in list_1:
    if num > 0 and sqrt(num) % 1 == 0:
        list_2.append(int(sqrt(num)))
print('ответ:', list_2)
...
if date != '':
    date = date.split('.')
    months = {'01': 'января', '02': 'февраля', '03': 'марарта', '04': 'апреля', '05': 'май', '06': 'июня', '07': 'июля',
    ...
    date_formatted = date[0] + ' ' + date[1] + ' ' + date[2] + ' ' "года"
    print(date_formatted.upper())
...
for item in lst:
    if lst.count(item) == 1:
        lst3.append(item)
print('не имеют повторений: ',lst3)
